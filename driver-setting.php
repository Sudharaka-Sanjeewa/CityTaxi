...
if(isset($_POST['update']))
{
    ...
    $query=mysqli_query($con,"select ID from driver where ID='$did' and Password='$cpassword'");
    $row=mysqli_fetch_array($query);
    
    if($row>0)
    {
        $ret=mysqli_query($con,"update driver set Password='$npassword' where ID='$did'");
...
<head>
    ...
    <title>Salon S | Driver Setting</title>
