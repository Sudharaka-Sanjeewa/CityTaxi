...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select * from passenger where Email='$email' && Password='$password'");
    $ret=mysqli_fetch_array($query);
    
    if($ret>0){
      $_SESSION['pid']=$ret['ID'];
      $_SESSION['pname']=$ret['Name'];
      $_SESSION['pmobile']=$ret['MobileNumber'];
...
<html lang="en">
  <head>
    ...
    <title>CityTaxi | Passenger Login</title>
                ...
                <h3>Login to Book Taxi</h3>
                    <form method="post">
                        ...
                        <div class="twice-two" style="padding-top:10px;">
                            <a class="link--gray" style="color: orangered;" href="passenger-forgot-password.php">Forgot Password?</a>
                        </div>
                        <div class="twice-two">
                        <a class="link--gray" style="color: orangered;" href="passenger-signup.php">Don't have an Account? <b>Sign Up</b></a>
                        </div>
