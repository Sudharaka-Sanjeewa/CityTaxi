...
if(isset($_POST['reset']))
{
    ...
    $query=mysqli_query($con,"update user set Password='$password' where Email='$email' && MobileNumber='$mobile'");
...
<title>Salon S | Reset Password</title>
				...
				<div class="widget-shadow">
					...
					<div class="login-body">
						<form role="form" method="post" action="" name="changepassword" onsubmit="return checkpass();">
							...
							<input type="password" name="npassword" class="lock" placeholder="New Password" required="true">
							<input type="password" name="conpassword" class="lock" placeholder="Confirm Password" required="true">
