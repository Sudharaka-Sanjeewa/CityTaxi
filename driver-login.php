...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select * from driver where Email='$email' && Password='$password'");
    $ret=mysqli_fetch_array($query);
    
    if($ret>0){
        $_SESSION['did']=$ret['ID'];
        header('location:driver-panel.php');
    }
    else{
...
<html lang="en">
  <head>
    ...
    <title>CityTaxi | Driver Login</title>
                ...
                <h3>Login to Driver Panel</h3>
                    <form method="post">
                        ...
                        <div class="twice-two" style="padding-top:10px;">
                          <a class="link--gray" style="color: orangered;" href="driver-forgot-password.php">Forgot Password?</a>
                        </div>
                        <div class="twice-two">
                        <a class="link--gray" style="color: orangered;" href="driver-signup.php">Don't have an Account? <b>Sign Up</b></a>
                        </div>
