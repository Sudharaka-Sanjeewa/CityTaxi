...
else
{
    ...
    // Calculate payment according Vehicles 
...
if(isset($_POST['driver']))
{
    ...
    else
    {
        ...
        if ($query)
        {
            ...
            {
                $mobileno="94{$pmobile}";
                $message="Hello {$pname}, Our taxi is booked for you. Driver - {$dname}. Vehicle - {$vehicle}. Mobile - {$dmobile}";
    ...
    <div class="recent-work">
        <div class="container">
            <div style="text-align: center;">
                <br><br><h5><b>Select your Driver & enjoy your journey</b></h5><br><br>
            </div>
            <div class="row">
                <?php
